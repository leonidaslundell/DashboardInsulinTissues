...
While there are many tools summarizing results, none that i know summarize T2D in various tissues. This scrip analyzes, and a diffent flexdashboard script visualizes them.
...
# adipose
gsetAdi <- getGEO("GSE40234", GSEMatrix =TRUE, AnnotGPL = T, destdir = "./data", getGPL = T)
gsetAdi <- gsetAdi$GSE40234_series_matrix.txt.gz

# beta cell
gsetBeta <- getGEO("GSE76894", GSEMatrix =TRUE, AnnotGPL = T, destdir = "./data", getGPL = T)
gsetBeta <- gsetBeta$GSE76894_series_matrix.txt.gz

# skeletal muslce
gsetSKM <- getGEO("GSE18732", GSEMatrix = TRUE, AnnotGPL = T, destdir = "./data", getGPL = T)
...
save(dat, file = "data/results.Rdata")
```
